# Generated by Django 5.1.6 on 2025-07-14 08:58
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post_img', models.ImageField(blank=True, null=True, upload_to='user_post/')),
                ('description', models.TextField(default='', max_length=1000)),
                ('hastags', models.TextField(default='', max_length=1000)),
                ('location', models.CharField(default='', max_length=500)),
                ('collaborators', models.CharField(default='', max_length=500)),
